  ...
  <div class="app-container">
    <section>
      ...
      <el-table :data="companies" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
        ...
        <el-table-column prop="telphone" label="电话" width="250">
        </el-table-column>
        ...
        <el-table-column label="操作" width="299">
          <template scope="scope">
            ...
            <el-button size="small" @click="handleProduct(scope.$index, scope.row)">负责产品</el-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 获取用户列表
      getUsers() {
        // const para = this.$route.params.cid;
        getCustomersList(this.$route.params.cid, this.listQuery).then(res => {
      ...
      handleAdd() {
        ...
        this.addForm = {
          ...
          password: '',
          telphone: '',
          company_id: parseInt(this.$route.params.cid)
        };
      },
      // 编辑
      editSubmit() {
      ...
      handleProduct(index, row) {
        ...
        this.$router.push('/clientcompany/subpage/cusproducts/' + id + '/' + cid);
      }
    },
    mounted() {
      this.getUsers();
